    ...
    <main className="max-w-4xl min-h-screen mx-auto px-4 py-12">
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-600">
          Restaurants must provide accurate and up-to-date business information during registration. We reserve the
          right to approve or deny any registration request at our sole discretion.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-600">
          You are responsible for keeping your menu, prices, and availability current. Any changes must be made promptly
          to avoid customer dissatisfaction or operational issues.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-600">
          Restaurants are expected to fulfill orders in a timely and professional manner. Cancellations, delays, or
          incorrect items may result in customer complaints and platform penalties.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-600">
          The Platform may deduct a commission fee from each order. Payment cycles, fees, and invoicing will be
          communicated through your dashboard and are subject to change.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-600">
          Restaurants must comply with all applicable food safety, hygiene, and licensing regulations. We reserve the
          right to suspend or remove any restaurant that fails to meet these standards.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-600">
          Either party may terminate the relationship at any time with notice. Upon termination, the restaurant’s
          profile and menu will be removed from the Platform.
        </p>
      </section>
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-600">
          We are not responsible for loss of profits, revenue, or data arising out of your use of the Platform. Use of
          the Platform is at your own risk.
        </p>
      </section>

      <p className="text-sm text-gray-400">
        By continuing to use our services, you agree to abide by these Terms. For questions or disputes, please contact
        us at <span className="underline">{process.env.E_MAIL}</span>..
      </p>
    </main>
  )
}
